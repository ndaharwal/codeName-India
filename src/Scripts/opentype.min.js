        ...
        1: [
            function (require, module, exports) {
                ...
                function tinf_build_bits_base(e, t, n, r) {
                    var s, i;
                    for (s = 0; s < n; ++s) e[s] = 0;
                    for (s = 0; s < 30 - n; ++s) e[s + n] = s / n | 0;
                    for (i = r, s = 0; s < 30; ++s) t[s] = i, i += 1 << e[s]
                }
                ...
                function tinf_build_tree(e, t, n, r) {
                    ...
                    for (s = 0; s < r; ++s) e.table[t[n + s]]++;
                    for (e.table[0] = 0, i = 0, s = 0; s < 16; ++s) offs[s] = i, i += e.table[s];
                    for (s = 0; s < r; ++s) t[n + s] && (e.trans[offs[t[n + s]]++] = s)
                }
                ...
                function tinf_decode_trees(e, t, n) {
                    var r, s, i, a, o, _;
                    for (r = tinf_read_bits(e, 5, 257), s = tinf_read_bits(e, 5, 1), i = tinf_read_bits(e, 4, 4), a = 0; a < 19; ++a) lengths[a] = 0;
                    for (a = 0; a < i; ++a) {
                ...
                function tinf_inflate_block_data(e, t, n) {
                    for (; ;) {
                        ...
                        if (r < 256) e.dest[e.destLen++] = r;
                            ...
                            var s, i, a, o;
                            for (r -= 257, s = tinf_read_bits(e, length_bits[r], length_base[r]), i = tinf_decode_symbol(e, n), a = e.destLen - tinf_read_bits(e, dist_bits[i], dist_base[i]), o = a; o < a + s; ++o) e.dest[e.destLen++] = e.dest[o]
                        }
                    }
                }
                ...
                function GlyphNames(e) {
                    ...
                    switch (e.version) {
                        case 1:
                            ...
                            break;
                        case 2:
                            for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++) e.glyphNameIndex[l] < exports.standardNames.length ? this.names[l] = exports.standardNames[e.glyphNameIndex[l]] : this.names[l] = e.names[e.glyphNameIndex[l] - exports.standardNames.length];
                            break;
                        case 2.5:
        ...
        6: [
            function (require, module, exports) {
                ...
                Font.prototype.hasChar = function (e) {
                    ...
                    if (t.features) {
                        ...
                        for (t.features.liga && (a = a.concat(this.substitution.getFeature("liga", s, t.language))), t.features.rlig && (a = a.concat(this.substitution.getFeature("rlig", s, t.language))), n = 0; n < o; n += 1)
                            for (var h = 0; h < a.length; h++) {
                                for (var u = a[h], l = u.sub, c = l.length, p = 0; p < c && l[p] === i[n + p];) p++;
                                p === c && (i.splice(n, c, u.by), o = o - c + 1)
                            }
                    }
                    var g = new Array(o),
                        f = this.glyphs.get(0);
                    for (n = 0; n < o; n += 1) g[n] = this.glyphs.get(i[n]) || f;
                    return g
                    ...
                    for (var s = 1 / this.unitsPerEm * i, a = this.stringToGlyphs(e, r), h = 0; h < a.length; h += 1) {
                        var u = a[h];
                    ...
                    if (util.isBrowser()) window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, i.byteLength, function (t) {
                        t.root.getFile(e, {
                            create: !0
                        }, function (e) {
        ...
        7: [
            function (require, module, exports) {
                ...
                Glyph.prototype.bindConstructorValues = function (t) {
                    ...
                    for (var a = 1 / this.path.unitsPerEm * e, o = n.xScale * a, h = n.yScale * a, r = new path.Path, s = this.path.commands, p = 0; p < s.length; p += 1) {
                        var y = s[p];
                    ...
                    function a(i, e, n, a) {
                        var o = 2 * Math.PI;
                        t.beginPath();
                        for (var h = 0; h < i.length; h += 1) t.moveTo(e + i[h].x * a, n + i[h].y * a), t.arc(e + i[h].x * a, n + i[h].y * a, 2, 0, o, !1);
                        t.closePath(), t.fill()
                    }
                    i = void 0 !== i ? i : 0, e = void 0 !== e ? e : 0, n = void 0 !== n ? n : 24;
                    for (var o = 1 / this.path.unitsPerEm * n, h = [], r = [], s = this.path, p = 0; p < s.commands.length; p += 1) {
                        var y = s.commands[p];
                        void 0 !== y.x && h.push({
                            x: y.x,
                            y: -y.y
            ...
            function (require, module, exports) {
                ...
                Layout.prototype = {
                    ...
                    getFeatureTable: function (e, t, r, a) {
                        ...
                        if (s) {
                            for (var n, i = s.featureIndexes, u = this.font.tables[this.tableName].features, l = 0; l < i.length; l++)
                                if (n = u[i[l]], n.tag === r) return n.feature;
                            if (a) {
                                var f = u.length;
                    ...
                    getLookupTables: function (e, t, r, a, s) {
                        var n = this.getFeatureTable(e, t, r, s),
                            i = [];
                        if (n) {
                            for (var u, l = n.lookupListIndexes, f = this.font.tables[this.tableName].lookups, o = 0; o < l.length; o++) u = f[l[o]], u.lookupType === a && i.push(u);
                            if (0 === i.length && s) {
                                u = {
                                    lookupType: a,
                                    lookupFlag: 0,
                    ...
                    expandCoverage: function (e) {
                        ...
                        for (var t = [], r = e.ranges, a = 0; a < r; a++)
                            for (var s = r[a], n = s.start, i = s.end, u = n; u <= i; u++) t.push(u);
                        return t
                    }
        ...
        10: [
            function (require, module, exports) {
                ...
                function parseBuffer(e) {
                    ...
                    for (var f, u, i, c, b, m, d, g, h, T, y = 0; y < s; y += 1) {
                        var v, F = o[y];
                        switch (F.tag) {
                            case "cmap":
        ...
        11: [
            function (require, module, exports) {
                ...
                exports.getByte = function (t, r) {
                    ...
                    for (var e = "", s = r; s < r + 4; s += 1) e += String.fromCharCode(t.getInt8(s));
                    return e
                }, exports.getOffset = function (t, r, e) {
                    for (var s = 0, a = 0; a < e; a += 1) s <<= 8, s += t.getUint8(r + a);
                    return s
                }, exports.getBytes = function (t, r, e) {
                    for (var s = [], a = r; a < e; a += 1) s.push(t.getUint8(a));
                    return s
                ...
                Parser.prototype.parseByte = function () {
                    ...
                    for (var a = 0; a < t; a++) s += String.fromCharCode(r.getUint8(e + a));
                    return s
                    ...
                    for (var r = new Array(t), e = this.data, s = this.offset + this.relativeOffset, a = 0; a < t; a++) r[a] = e.getUint16(s), s += 2;
                    return this.relativeOffset += 2 * t, r
                }, Parser.prototype.parseList = function (t, r) {
                    r || (r = t, t = this.parseUShort());
                    for (var e = new Array(t), s = 0; s < t; s++) e[s] = r.call(this);
                    return e
                }, Parser.prototype.parseRecordList = function (t, r) {
                    r || (r = t, t = this.parseUShort());
                    for (var e = new Array(t), s = Object.keys(r), a = 0; a < t; a++) {
                    ...
                    if (r > 0) return new Parser(this.data, this.offset + r).parseStruct(t)
                }, Parser.prototype.parseListOfLists = function (t) {
                    for (var r = this.parseOffset16List(), e = r.length, s = this.relativeOffset, a = new Array(e), o = 0; o < e; o++) {
                        var i = r[o];
                        if (0 !== i)
                    ...
                    if (2 === r) {
                        for (var s = new Array(e), a = 0; a < e; a++) s[a] = {
        ...
        12: [
            function (require, module, exports) {
                ...
                Path.prototype.moveTo = function (t, o) {
                    ...
                    for (var t = new bbox.BoundingBox, o = 0, e = 0, i = 0, a = 0, r = 0; r < this.commands.length; r++) {
        ...
        13: [
            function (require, module, exports) {
                ...
                Substitution.prototype = Layout.prototype, Substitution.prototype.createDefaultTable = function () {
                    ...
                    for (var a = [], s = this.getLookupTables(e, r, t, 1), o = 0; o < s.length; o++)
                        for (var u = s[o].subtables, i = 0; i < u.length; i++) {
                            var n, l = u[i],
                    ...
                    for (var a = [], s = this.getLookupTables(e, r, t, 3), o = 0; o < s.length; o++)
                        for (var u = s[o].subtables, i = 0; i < u.length; i++)
                            for (var n = u[i], l = this.expandCoverage(n.coverage), g = n.alternateSets, c = 0; c < l.length; c++) a.push({
                                sub: l[c],
                                by: g[c]
                            });
                    return a
                }, Substitution.prototype.getLigatures = function (t, e, r) {
                    for (var a = [], s = this.getLookupTables(e, r, t, 4), o = 0; o < s.length; o++)
                        for (var u = s[o].subtables, i = 0; i < u.length; i++)
                            for (var n = u[i], l = this.expandCoverage(n.coverage), g = n.ligatureSets, c = 0; c < l.length; c++)
                                for (var b = l[c], h = g[c], p = 0; p < h.length; p++) {
                                    var f = h[p];
                                    a.push({
                    ...
                    if (l >= 0) {
                        for (var g = o.ligatureSets[l], c = 0; c < g.length; c++)
                            if (arraysEqual(g[c].components, i)) return;
                        g.push(n)
                    } else l = -1 - l, o.coverage.glyphs.splice(l, 0, u), o.ligatureSets.splice(l, 0, [n])
                }, Substitution.prototype.getFeature = function (t, e, r) {
                    if (/ss\d\d/.test(t)) return this.getSingle(t, e, r);
                    switch (t) {
                        case "aalt":
                        case "salt":
                    ...
                    if (/ss\d\d/.test(t)) return this.addSingle(t, e, r, a);
                    switch (t) {
                        case "aalt":
                        case "salt":
        ...
        14: [
            function (require, module, exports) {
                ...
                function recordList(e, t, a) {
                    ...
                    for (var s = 0; s < r; s++) o = o.concat(a(t[s], s));
                    return o
                }
            ...
            function (require, module, exports) {
                ...
                function parseCFFIndex(e, t, a) {
                    ...
                    if (0 !== h) {
                        ...
                        n = t + (h + 1) * f + 2;
                        var p = t + 3;
                        for (r = 0; r < h + 1; r += 1) i.push(parse.getOffset(e, p, f)), p += f;
                        s = n + i[h]
                    } else s = t + 2;
                ...
                function parseOperand(e, t) {
                    ...
                    if (t >= 247 && t <= 250) return a = e.parseByte(), 256 * (t - 247) + a + 108;
                    if (t >= 251 && t <= 254) return a = e.parseByte(), 256 * -(t - 251) - a - 108;
                ...
                function parseCFFCharset(e, t, a, r) {
                    ...
                    var h = [".notdef"],
                        f = o.parseCard8();
                    if (0 === f)
                        for (n = 0; n < a; n += 1) s = o.parseSID(), h.push(getCFFString(r, s));
                    else if (1 === f)
                        for (; h.length <= a;)
                            for (s = o.parseSID(), i = o.parseCard8(), n = 0; n <= i; n += 1) h.push(getCFFString(r, s)), s += 1;
                    else {
                        if (2 !== f) throw new Error("Unknown charset format " + f);
                        for (; h.length <= a;)
                            for (s = o.parseSID(), i = o.parseCard16(), n = 0; n <= i; n += 1) h.push(getCFFString(r, s)), s += 1
                    }
                    return h
                }

                function parseCFFEncoding(e, t, a) {
                    var r, n, s = {}, i = new parse.Parser(e, t),
                        o = i.parseCard8();
                    if (0 === o) {
                        var h = i.parseCard8();
                        for (r = 0; r < h; r += 1) n = i.parseCard8(), s[n] = r
                    } else {
                        if (1 !== o) throw new Error("Unknown encoding format " + o);
                        var f = i.parseCard8();
                        for (n = 1, r = 0; r < f; r += 1)
                            for (var p = i.parseCard8(), u = i.parseCard8(), c = p; c <= p + u; c += 1) s[c] = n, n += 1
                    }
            ...
            function (require, module, exports) {
                ...
                function parseCmapTableFormat12(e, a) {
                    ...
                    for (e.groupCount = t = a.parseULong(), e.glyphIndexMap = {}, r = 0; r < t; r += 1)
                        for (var n = a.parseULong(), s = a.parseULong(), o = a.parseULong(), l = n; l <= s; l += 1) e.glyphIndexMap[l] = o, o++
                }
                ...
                function parseCmapTableFormat4(e, a, r, t, n) {
                    ...
                    var l = new parse.Parser(r, t + n + 14),
                        ...
                        u = t + n + 16 + 8 * o;
                    for (s = 0; s < o - 1; s += 1)
                        for (var h, f = l.parseUShort(), c = p.parseUShort(), d = g.parseShort(), i = m.parseUShort(), v = c; v <= f; v += 1) 0 !== i ? (u = m.offset + m.relativeOffset - 2, u += i, u += 2 * (v - c), h = parse.getUShort(r, u), 0 !== h && (h = h + d & 65535)) : h = v + d & 65535, e.glyphIndexMap[v] = h
                }
        ...
        17: [
            function (require, module, exports) {
                ...
                function parseFvarTable(e, a, r) {
                    ...
                    n.skip("uShort", 1);
                    for (var u = n.parseUShort(), i = n.parseUShort(), p = n.parseUShort(), l = n.parseUShort(), v = [], o = 0; o < u; o++) v.push(parseFvarAxis(e, a + s + o * i, r));
                    for (var m = [], f = a + s + u * i, c = 0; c < p; c++) m.push(parseFvarInstance(e, f + c * l, v, r));
                    return {
                        axes: v,
                        instances: m
                    }
                    ...
                    if (e.numberOfContours > 0) {
                        ...
                        for (a = [], s = 0; s < i; s += 1)
                            if (n = o.parseByte(), a.push(n), (8 & n) > 0)
                                for (var h = o.parseByte(), l = 0; l < h; l += 1) a.push(n), s += 1;
                        if (check.argument(a.length === i, "Bad flags."), p.length > 0) {
                            var u, c = [];
                            if (i > 0) {
                                for (s = 0; s < i; s += 1) n = a[s], u = {}, u.onCurve = !!(1 & n), u.lastPointOfContour = p.indexOf(s) >= 0, c.push(u);
                                var y = 0;
                                for (s = 0; s < i; s += 1) n = a[s], u = c[s], u.x = parseGlyphCoordinate(o, n, y, 2, 16), y = u.x;
                                var f = 0;
                                for (s = 0; s < i; s += 1) n = a[s], u = c[s], u.y = parseGlyphCoordinate(o, n, f, 4, 32), f = u.y
                            }
                            e.points = c
                        } else e.points = []
        ...
        19: [
            function (require, module, exports) {
                ...
                function parseTaggedListTable(r, e) {
                    for (var a = new parse.Parser(r, e), s = a.parseUShort(), t = [], o = 0; o < s; o++) t[a.parseTag()] = {
                ...
                function parseCoverageTable(r, e) {
                    ...
                    if (2 === s) {
                        for (var o = []; t--;)
                            for (var p = a.parseUShort(), n = a.parseUShort(), f = a.parseUShort(), i = p; i <= n; i++) o[f++] = i;
                        return o
                    }
                }
                ...
                function parseClassDefTable(r, e) {
                    ...
                    if (2 === s) {
                        for (var n = a.parseUShort(), f = [], i = [], h = [], S = 0; S < n; S++) f[S] = a.parseUShort(), i[S] = a.parseUShort(), h[S] = a.parseUShort();
                        return function (r) {
                            for (var e = 0, a = f.length - 1; e < a;) {
                                var s = e + a + 1 >> 1;
                                r < f[s] ? a = s - 1 : e = s
                            }
                ...
                function parsePairPosSubTable(r, e) {
                    ...
                    if (4 === f && 0 === i) {
                        var h = {};
                        if (1 === o) {
                            for (var S = t.parseUShort(), u = [], v = t.parseOffset16List(S), U = 0; U < S; U++) {
                                var l = v[U],
                                    g = h[l];
                                if (!g) {
                        ...
                        if (2 === o) {
                            for (var b = t.parseUShort(), P = t.parseUShort(), L = t.parseUShort(), k = t.parseUShort(), d = parseClassDefTable(r, e + b), w = parseClassDefTable(r, e + P), O = [], C = 0; C < L; C++)
                ...
                function parseGposTable(r, e, a) {
                    ...
                    var o = s.parseUShort();
                    s.relativeOffset = o;
                    for (var p = s.parseUShort(), n = s.parseOffset16List(p), f = e + o, i = 0; i < p; i++) {
        ...
        23: [
            function (require, module, exports) {
                ...
                function parseHmtxTable(e, a, r, t, s) {
                    for (var i, l, n = new parse.Parser(e, a), p = 0; p < t; p += 1) {
        ...
        24: [
            function (require, module, exports) {
                ...
                function parseKernTable(r, e) {
                    var a = new parse.Parser(r, e),
                        s = a.parseUShort();
                    if (0 === s) return parseWindowsKernTable(a);
                    if (1 === s) return parseMacKernTable(a);
        ...
        25: [
            function (require, module, exports) {
                ...
                function parseLocaTable(r, a, e, s) {
                    for (var p = new parse.Parser(r, a), o = s ? p.parseUShort : p.parseULong, t = [], c = 0; c < e + 1; c += 1) {
                        var n = o.call(p);
                        s && (n *= 2), t.push(n)
                    }
                    return t
        ...
        26: [
            function (require, module, exports) {
                ...
                function parseLtagTable(e, a) {
                    ...
                    for (var n = r.parseULong(), s = [], l = 0; l < n; l++) {
                        for (var p = "", u = a + r.parseUShort(), g = r.parseUShort(), o = u; o < u + g; ++o) p += String.fromCharCode(e.getInt8(o));
                        s.push(p)
                    }
                    return s
                }
        ...
        28: [
            function (require, module, exports) {
                ...
                function parseMetaTable(e, a) {
                    ...
                    for (var s = r.parseULong(), n = {}, p = 0; p < s; p++) {
                        var l = r.parseTag(),
                            u = r.parseULong(),
                            o = r.parseULong(),
        ...
        29: [
            function (require, module, exports) {
                ...
                function parseNameTable(e, a, r) {
                    for (var n = {}, s = new parse.Parser(e, a), t = s.parseUShort(), m = s.parseUShort(), c = s.offset + s.parseUShort(), i = 0; i < m; i++) {
                        var o = s.parseUShort(),
                            u = s.parseUShort(),
                            l = s.parseUShort(),
                            g = s.parseUShort(),
                ...
                function addStringToPool(e, a) {
                    ...
                    if (r < 0) {
                        r = a.length;
                        for (var n = 0, s = e.length; n < s; ++n) a.push(e[n])
                    }
                    return r
                }
                ...
                function makeNameTable(e, a) {
                    var r, n = [],
                        s = {}, t = reverseDict(nameTableNames);
                    for (var m in e) {
                        var c = t[m];
                        if (void 0 === c && (c = m), r = parseInt(c), isNaN(r)) throw new Error('Name table entry "' + m + '" does not exist, see nameTableNames for complete list.');
                        s[r] = e[m], n.push(r)
                    }
                    for (var i = reverseDict(macLanguages), o = reverseDict(windowsLanguages), u = [], l = [], g = 0; g < n.length; g++) {
                        r = n[g];
                        var d = s[r];
                        for (var f in d) {
                            var p = d[f],
        ...
        30: [
            function (require, module, exports) {
                ...
                function parseOS2Table(e, n) {
                    ...
                    for (var t = 0; t < 10; t++) a.panose[t] = i.parseByte();
            ...
            function (require, module, exports) {
                ...
                function fontToSfntTable(e) {
                    for (var a, n = [], t = [], r = [], i = [], s = [], l = [], u = [], m = 0, h = 0, o = 0, c = 0, d = 0, g = 0; g < e.glyphs.length; g += 1) {
                        ...
                        if (v < 32) h |= 1 << v;
                        else if (v < 64) o |= 1 << v - 32;
                        else if (v < 96) c |= 1 << v - 64;
                        else {
        ...
        33: [
            function (require, module, exports) {
                ...
                encode.BYTE = function (e) {
                    ...
                    a += 1 & a.length ? "f" : "ff";
                    var f = [30];
                    for (o = 0, r = a.length; o < r; o += 2) f.push(parseInt(a.substr(o, 2), 16));
                    return f
                    ...
                    for (var c = [], o = t, r = 0; r < o; r++, n += 1) c[r] = e.getUint8(n);
                    return String.fromCharCode.apply(null, c)
                }, decode.UTF16 = function (e, n, t) {
                    for (var c = [], o = t / 2, r = 0; r < o; r++, n += 2) c[r] = e.getUint16(n);
                    return String.fromCharCode.apply(null, c)
                ...
                var macEncodingTableCache = "function" == typeof WeakMap && new WeakMap,
                    macEncodingCacheKeys, getMacEncodingTable = function (e) {
                        ...
                        if (void 0 !== t) {
                            ...
                            if (void 0 !== o) {
                                for (var r = {}, a = 0; a < o.length; a++) r[o.charCodeAt(a)] = a + 128;
                ...
                encode.MACSTRING = function (e, n) {
                    ...
                    if (void 0 !== t) {
                        for (var c = [], o = 0; o < e.length; o++) {
                            ...
                            if (r >= 128 && (r = t[r], void 0 === r)) return;
                            c[o] = r
                        }
                        return c
                    }
                    ...
                    for (var n = [], t = Object.keys(e), c = t.length, o = 0; o < c; o += 1) {
                    ...
                    var t = [];
                    if (Array.isArray(n))
                        for (var c = 0; c < n.length; c += 1) check.argument(e.length === n.length, "Not enough arguments given for type" + n), t = t.concat(encode.OPERAND(e[c], n[c]));
                ...
                encode.CHARSTRING = function (e) {
                    ...
                    for (var t = [], c = e.length, o = 0; o < c; o += 1) {
                        var r = e[o];
                    ...
                    for (var n = 0, t = e.fields.length, c = 0; c < t; c += 1) {
                        var o = e.fields[c],
                            r = sizeOf[o.type];
